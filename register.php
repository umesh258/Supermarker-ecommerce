<?php
	...
	if($_POST)
	{
		...
		if($pass == $cpass)
		{
			$sq = mysqli_query($con,"insert into tbl_user (user_name,user_email,user_password) values ('$fname','$email','$pass')")or die("Error in Insert".mysqli_error($con));

			if($sq)
			{
				echo "<script>alert('Registeration Completed !');window.location='login.php';</script>";	
			}
		}else
		{
			echo "<script>alert('Password and Confirmpassword must be same !');</script>";
		}
