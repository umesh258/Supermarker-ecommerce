...
if(isset($_POST['lsubmit']))
{
	...
	$sq = mysqli_query($con,"select * from tbl_user where user_email='{$email}' and user_password='{$pass}'")or die("error in select".mysqli_error($con));
	...
	if($count > 0)
	{
		$_SESSION['name'] = $fr['user_name'];
		$_SESSION['id'] = $fr['user_id'];
...
<!-- login -->
	<div class="login">
		<div class="container">
			...
			<p><a href="register.php">Register Here</a> (Or) go back to <a href="home.php">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<?php
