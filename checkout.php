				...
				<table class="timetable_sub">
					...
					<?php
						...
						foreach($_SESSION['productcart'] as $key => $value)
						{
							...
							$i++;
							$subtotal = $pfr['product_price'] * $qty;
							
						
					?>
					<tr class="rem1">
						<td class="invert"><?php echo $i; ?></td>
						<?php echo "<td class='invert-image'><a href='#'><img style='width: 50px;' src='{$pfr['product_image']}' alt='456' class='img-responsive' /></a></td>";?>
						<td class="invert">
							 <div class="quantity"> 
						...
						<td class="invert"><?php echo $pfr['product_name'] ?></td>
						
						<td class="invert">Rs.<b><?php echo $pfr['product_price'] ?></b></td>
						<td class="invert">Rs.<b><?php echo $subtotal ?></b></td>
						<td class="invert">
							<div class="rem">
								<div > 
								<?php echo "<a href='?id={$key}'>Remove </a>"; ?>
								</div>
							</div>
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						<li>Total Amount <i>-</i> <span>Rs.<b><?php echo $finalsum; ?></b></span></li>
					</ul>
					<?php 
				 }else
				 {
				...
				<div class="checkout-right-basket">
					...
					echo "<a href='placeorder.php'><span class='glyphicon glyphicon-menu-left' aria-hidden='true'></span>Place Order</a>";
					}else
					{
